# -*- coding: utf-8 -*-
"""
Created on Sat Apr 17 11:26:34 2021
...
import pandas as pd
# Loading dataset
patient_data = pd.read_csv("F:/assignment/survival analytics/Datasets_Survival Analytics/Patient.csv")
patient_data.head()
...
import pandas as pd
# Loading dataset
ECG_data = pd.read_excel("F:/assignment/survival analytics/Datasets_Survival Analytics/ECG_Surv.xlsx")
ECG_data.head()
ECG_data.describe()
ECG_data.columns
